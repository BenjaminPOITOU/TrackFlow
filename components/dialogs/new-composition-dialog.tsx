...
import { X, Music, Upload, Clock } from "lucide-react"
...
export function NewCompositionDialog({ projectId, projectTitle, onClose, onSave }: NewCompositionDialogProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
      <div className="bg-[#0D0D0D] border border-[#333333] rounded-lg w-full max-w-3xl p-6 relative">
        {/* Bouton de fermeture */}
        <Button
          variant="ghost"
          size="icon"
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-[#EFEFEF]">PROJECT: {projectTitle}</p>
          </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="composition-key" className="text-[#EFEFEF]">
                KEY
              </Label>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {selectedInstruments.map((instrument) => (
                  <Tag
                    key={instrument}
                    variant={instrument.toLowerCase() as any}
                    className="cursor-pointer"
                    onClick={() => toggleInstrument(instrument)}
                  >
