...
export function ProjectDetailView({ projectId, onSelectComposition }: ProjectDetailViewProps) {
  ...
  const compositions = [
    { id: 101, title: "INTRO_MASTER", branch: "main", duration: "3:42", date: "24/03/2025", versions: 5, branches: 2 },
    { id: 102, title: "VERSE_EXP", branch: "dev", duration: "2:18", date: "23/03/2025", versions: 3, branches: 1 },
    {
      id: 103,
    ...
    { id: 104, title: "OUTRO_AMBIENT", branch: "main", duration: "4:12", date: "21/03/2025", versions: 2, branches: 1 },
    {
      id: 105,
    ...
    { id: 107, title: "SYNTH_LEAD", branch: "dev", duration: "3:08", date: "18/03/2025", versions: 6, branches: 2 },
    { id: 108, title: "BASS_SEQUENCE", branch: "main", duration: "2:24", date: "17/03/2025", versions: 4, branches: 1 },
  ]
          ...
          {compositions.map((composition) => (
            ...
            >
              ...
              <div className="col-span-2 flex items-center">
                <div
                  className={`border border-[#333333] px-1.5 py-0 text-xs branch-${composition.branch.replace("/", "-")}`}
                >
                  {composition.branch}
                </div>
              </div>
              <div className="col-span-1 flex items-center text-[#EFEFEF]">{composition.duration}</div>
              <div className="col-span-2 flex items-center gap-1 text-[#EFEFEF]">
                <span>{composition.versions} VERSIONS</span>
                <span className="text-[#666666]">|</span>
                <span>{composition.branches} BRANCHES</span>
              </div>
              <div className="col-span-2 flex items-center text-[#EFEFEF]">{composition.date}</div>
